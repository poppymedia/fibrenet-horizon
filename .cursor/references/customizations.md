...
- **H1 on product:** Same unified H1 rule as blog/page (`--font-h1--*` with brand fallbacks, `--head-to-title-gap`); centred in the product column via `.product-information--split`. No `body.template-*` scoping — use section/layout classes instead.
